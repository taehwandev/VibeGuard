const translations = {
  en: {
    ...
    playbookHeading: "Use VibeGuard with AgentPlaybook when the work needs a full agent workflow.",
    ...
    playbookAgentTitle: "AgentPlaybook is the execution playbook",
    ...
    playbookButton: "Open AgentPlaybook",
...
Overall: ✅ Ready`,
  ...
  ko: {
    ...
    playbookHeading: "작업 흐름까지 필요하다면 VibeGuard와 AgentPlaybook을 함께 쓰세요.",
    ...
    playbookAgentTitle: "AgentPlaybook은 실행 플레이북입니다",
    ...
    playbookButton: "AgentPlaybook 열기",
