...
function localizeAppliedFix(language, item) {
  ...
  const exactKeys = new Map([
    ...
    ["Updated .vibeguard.json.", "fixes.updatedConfig"],
    ["Updated .gitignore VibeGuard local state rules.", "fixes.updatedStateGitignore"],
    ["Updated VibeGuard update check state.", "fixes.updatedUpdateState"],
