...
const MESSAGES = {
  en: {
    ...
    "finding.envProtection.recommendation": "Run `vibeguard audit --fix` to add `.env`, `.env.*`, and `!.env.example` rules.",
  ...
  ko: {
    ...
    "finding.envProtection.recommendation": "`vibeguard audit --fix`로 `.env`, `.env.*`, `!.env.example` 규칙을 추가하세요.",
