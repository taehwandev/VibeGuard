...
const MESSAGES = {
  en: {
    ...
    "finding.paidDependency.recommendation": "Confirm budget limits, request limits, simpler alternatives, and separation between test and production keys. After review, acknowledge exact package names under `cost.acknowledgedPaidDependencies` in `.vibeguard.json`.",
  ...
  ko: {
    ...
    "finding.paidDependency.recommendation": "예산 제한, 요청 횟수 제한, 더 단순한 대안, 테스트 키와 운영 키 분리를 확인하세요. 검토 후 `.vibeguard.json`의 `cost.acknowledgedPaidDependencies`에 정확한 패키지명을 기록할 수 있습니다.",
