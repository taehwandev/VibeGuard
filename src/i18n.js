...
const MESSAGES = {
  en: {
    ...
    "prompt.rule4": approvalPolicy.rule,
  ...
  ko: {
    ...
    "prompt.rule4": "데이터 삭제, 마이그레이션, 프로덕션 배포, 유료 사용량 증가, 반복 인프라 추가, 자격 증명 변경에는 명시적 사용자 권한이 필요합니다. 실행 전에 정확한 대상과 작업이 기존 승인 범위에 포함되는지 확인하세요. 승인 범위 안의 수정과 재시도는 계속 진행하며 소스 리비전 변경만으로 승인이 사라지지 않습니다. 대상·작업이 불명확하거나 범위·중대한 위험이 달라지거나 사용자가 중단·제한·철회하면 질문하세요. 침묵에서 승인을 추론하거나 다른 작업, 새 버전, 파괴적 작업, 승인되지 않은 태그 덮어쓰기로 확대하지 마세요.",
