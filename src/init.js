...
2. If \`vibe-guard\` is unavailable, run \`npm exec --yes vibe-guard@latest -- audit .\` instead and use the same \`npm exec --yes vibe-guard@latest -- ...\` form for fixes.
...
Refresh this managed block with \`vibe-guard init .\`, or with \`npm exec --yes vibe-guard@latest -- init .\` when using the latest published tool.
${AGENT_RULE_END}`;
}
